...
$(document).ready(function () {
    $('#datatable').DataTable({
        ajax: {
            url: 'http://localhost:9000/simps/api/inventario/brands/datatable?page=0&size=150&column_order=name&column_direction=asc',
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/inventario/brands/' + id : 'http://localhost:9000/simps/api/inventario/brands';
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/inventario/brands/' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
