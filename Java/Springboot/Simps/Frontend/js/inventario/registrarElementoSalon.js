...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: 'http://localhost:9000/simps/api/inventario/elementsClassrooms/datatable?page=0&size=150&column_order=amount&column_direction=asc',
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/inventario/elementsClassrooms/' + id : 'http://localhost:9000/simps/api/inventario/elementsClassrooms';
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/inventario/elementsClassrooms/' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
...
function findById(id) {
    $.ajax({
        ...
        $("#elementId").val(item.elementId.id)
        $("#classroomId").val(item.classroomId.id)
        if (item.state == true) {
