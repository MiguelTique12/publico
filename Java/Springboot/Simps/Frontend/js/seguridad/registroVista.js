...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: 'http://localhost:9000/simps/api/seguridad/views/datatable?page=0&size=100&column_order=code&column_direction=asc',
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/seguridad/views/' + id : 'http://localhost:9000/simps/api/seguridad/views';
    ...
    $.ajax({
        ...
        var mensaje = actualizar ? 'Hecho! vista  Actualizada' : 'Hecho! vista Guardada';
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/seguridad/views/' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
