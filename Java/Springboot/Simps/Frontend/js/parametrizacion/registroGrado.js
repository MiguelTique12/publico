...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: 'http://localhost:9000/simps/api/parametrizacion/grades/datatable?page=0&size=150&column_order=name&column_direction=state/',
        ...
        "footerCallback": function (row, data, start, end, display) {
            var api = this.api();
            $('#datetime-footer').html('<strong>Fecha y hora actual: <span id="current-datetime"></span></strong>'); // Texto "Fecha y hora actual" en negrita
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/parametrizacion/grades/' + id : 'http://localhost:9000/simps/api/parametrizacion/grades';
    var viewsIds = []; // Aquí almacenaremos los IDs de las Views seleccionadas, supongamos que las IDs se obtienen de algún lugar en tu frontend.
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/parametrizacion/grades/' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
