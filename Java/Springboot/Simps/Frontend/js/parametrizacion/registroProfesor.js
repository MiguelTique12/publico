...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: 'http://localhost:9000/simps/api/parametrizacion/teachers/datatable?page=0&size=150&column_order=user_id&column_direction=asc',
...
$(document).ready(function () {
    ...
    $("#curseName").on("change", function () {
        var selectedViewId = $(this).val();
        var selectedViewLabel = $("#curseName option:selected").text();
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/parametrizacion/teachers/' + id : 'http://localhost:9000/simps/api/parametrizacion/teachers';
    ...
    $.ajax({
        ...
        var mensaje = actualizar ? 'Hecho! profesor Actualizado' : 'Hecho! profesor Guardado';
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/parametrizacion/teachers/' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
...
function findById(id) {
    $.ajax({
        ...
        $("#id").val(item.id)
        $("#contractDate").val(item.code)
        $("#userId").val(item.description);
