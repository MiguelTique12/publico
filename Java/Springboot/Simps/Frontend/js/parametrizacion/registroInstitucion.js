...
$(document).ready(function () {
  var table = $('#datatable').DataTable({
    ...
    ajax: {
      url: 'http://localhost:9000/simps/api/parametrizacion/institutes/datatable?page=0&size=150&column_order=name&column_direction=address',
...
function Add() {
  ...
  var url = actualizar ? 'http://localhost:9000/simps/api/parametrizacion/institutes/' + id : 'http://localhost:9000/simps/api/parametrizacion/institutes';
  ...
  $.ajax({
    ...
    var mensaje = actualizar ? 'Hecho! Persona Actualizada' : 'Hecho! institusion Guardada';
...
function deleteById(id) {
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.isConfirmed) {
      $.ajax({
        url: 'http://localhost:9000/simps/api/parametrizacion/institutes/' + id,
        method: "delete",
        headers: {
          "Content-Type": "application/json"
        }
