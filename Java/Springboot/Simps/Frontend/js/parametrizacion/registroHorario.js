...
// Objeto de mapeo de nombres de días de la semana en inglés a español
var dayTranslation = {
    "MONDAY": "Lunes",
    "TUESDAY": "Martes",
    "WEDNESDAY": "Miércoles",
...
// Función para traducir el nombre del día
function translateDay(day) {
    return dayTranslation[day] || day; // Usa la traducción o el valor original si no se encuentra una traducción
}
...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: 'http://localhost:9000/simps/api/parametrizacion/schendules/datatable?page=0&size=150&column_order=start_time&column_direction=asc',
        ...
        columns: [
            ...
            { "data": "endTime" },
            {
                ...
                "render": function (data, type, row) {
                    // Traduce el nombre del día antes de mostrarlo
                    return translateDay(data);
                }
            },
            {
                "data": "state",
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/parametrizacion/schendules/' + id : 'http://localhost:9000/simps/api/parametrizacion/schendules';
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/parametrizacion/schendules/' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
