...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: 'http://localhost:9000/simps/api/parametrizacion/classrooms/datatable?page=0&size=150&column_order=name&column_direction=asc',
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/parametrizacion/classrooms/' + id : 'http://localhost:9000/simps/api/parametrizacion/classrooms';
    ...
    $.ajax({
        ...
        var mensaje = actualizar ? 'Hecho! elemento Actualizada' : 'Hecho! eleento Guardada';
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/parametrizacion/classrooms/' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
