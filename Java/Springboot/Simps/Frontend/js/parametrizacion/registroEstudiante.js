...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: 'http://localhost:9000/simps/api/parametrizacion/students/datatable?page=0&size=150&column_order=user_id&column_direction=asc',
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/parametrizacion/students/' + id : 'http://localhost:9000/simps/api/parametrizacion/students';
    ...
    $.ajax({
        ...
        var mensaje = actualizar ? 'Hecho! Persona Actualizada' : 'Hecho! estudiante Guardada';
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/parametrizacion/students/' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
...
function findById(id) {
    $.ajax({
        ...
        $("#id").val(item.id)
        $("#enrollmentDate").val(item.enrollmentDate)
