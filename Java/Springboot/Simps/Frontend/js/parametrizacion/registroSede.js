...
$(document).ready(function () {
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: 'http://localhost:9000/simps/api/parametrizacion/headquaters/datatable?page=0&size=150&column_order=name&column_direction=asc',
...
function Add() {
    ...
    var url = actualizar ? 'http://localhost:9000/simps/api/parametrizacion/headquaters/' + id : 'http://localhost:9000/simps/api/parametrizacion/headquaters';
...
function deleteById(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: 'http://localhost:9000/simps/api/parametrizacion/headquaters/1' + id,
                method: "delete",
                headers: {
                    "Content-Type": "application/json"
                }
...
function findById(id) {
    $.ajax({
        url: 'http://localhost:9000/simps/api/parametrizacion/headquaters/' + id,
        method: "GET",
        headers: {
            "Content-Type": "application/json"
        }
        ...
        $("#mail").val(item.mail)
        $("#nit").val(item.nit)
        $("#instituteId").val(item.instituteId.id)
        if (item.state == true) {
