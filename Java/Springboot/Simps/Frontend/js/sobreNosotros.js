var sliderTeam = (function (document, $) {
    ...
    var $sliderTeams = $('.slider--teams'),
        ...
        _initWidth = function () {
            ...
            $sliderTeams.velocity({ opacity: 1 }, { display: "block" }, { delay: 400 });
        },
...
function proximamente(){
    Swal.fire({
        position: 'center',
        icon: 'info',
        title: 'Gracias por preguntarte',
        text: 'Queremos que vivas informado, por ello nos encontramos trabajamos día tras día',
