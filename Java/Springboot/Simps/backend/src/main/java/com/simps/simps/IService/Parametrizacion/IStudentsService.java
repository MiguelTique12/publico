...
public interface IStudentsService extends IBasicMethodsService<Students>{

	/**
     * Recupera una lista paginada de estudiantes que coincidan con una cadena de búsqueda.
     *
